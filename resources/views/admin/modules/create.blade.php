    ...
    <div class="admin-card space-y-4 p-6">
        <form method="POST" action="{{ route('admin.modules.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="title" required value="{{ old('title') }}" placeholder="e.g. Module 1: Introduction" class="admin-input">
            </div>

            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="admin-label">Order</label>
                    <input type="number" name="order" min="0" value="{{ old('order', 0) }}" class="admin-input">
                </div>
                <div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="url" name="live_class_link" value="{{ old('live_class_link') }}" placeholder="https://..." class="admin-input">
                </div>
                <div>
            ...
            <div class="flex justify-end gap-3 pt-2">
                ...
                <button type="submit" class="admin-btn admin-btn-primary">Create Module</button>
            </div>
        </form>
    </div>
</div>

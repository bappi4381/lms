    ...
    <div class="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-xs">
        <form method="POST" action="{{ route('admin.categories.update', $category) }}" class="space-y-6">
            ...
            <div>
                ...
                <p class="text-xs text-slate-500 mb-4">Edit category names and auto-generated slugs.</p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <span class="text-[11px] text-slate-400 mt-1 block">Current Slug: {{ $category->slug_en }}</span>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               required 
                               class="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500">
                        <span class="text-[11px] text-slate-400 mt-1 block">Current Slug: {{ $category->slug_bn }}</span>
                    </div>
                </div>
            </div>

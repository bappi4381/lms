...
>
    <button
        type="button"
        class="group/disclosure-button mb-[2px] flex h-10 w-full items-center rounded-md-md text-neu-muted hover:shadow-neu-raised-sm hover:text-neu-heading lg:h-8 transition-all duration-200"
    >
        <div class="ps-3 pe-4">
    ...
    <div class="relative hidden space-y-[2px] ps-7 data-open:block" @if ($expanded === true) data-open @endif>
        <div class="absolute inset-y-[3px] start-0 ms-4 w-px bg-neu-dark/10"></div>
...
<div {{ $attributes->class('block space-y-[2px]') }}>
    <div class="px-1 py-2">
        <div class="text-xs leading-none text-neu-muted">{{ $heading }}</div>
    </div>
